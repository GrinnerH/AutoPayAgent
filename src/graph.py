...
from utils import AgentState, WalletProvider
...
def build_graph(wallet_provider: WalletProvider, checkpointer=None):
    ...
    builder.add_conditional_edges("risk_assessor", route_after_risk)
    builder.add_conditional_edges("human_approver", route_after_human)
    ...
    builder.add_conditional_edges("reflection_rewriter", route_after_reflection)
